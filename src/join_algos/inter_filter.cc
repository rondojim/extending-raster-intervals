...
bool RasterGrid::set_segment_borders_types(
  ...
  if (parallelism == 1) {
    ...
    if (y_is_on_grid_row) {
      // std::cout << "y_is_on_grid_row: " << p1.to_str() << " - " <<
      // p2.to_str() << std::endl;
    ...
    if (y_is_on_grid_col) {
      // std::cout << "y_is_on_grid_col: " << p1.to_str() << " - " <<
      // p2.to_str() << std::endl;
      ...
      // std::cout << "on_grid_min_y: " << on_grid_min_y << ", ymin: " << ymin
      // << std::endl; std::cout << "on_grid_max_y: " << on_grid_max_y << ",
      // ymin: " << ymin << std::endl;
      min_row_idx = sequence_idx(on_grid_min_y, ymin);
      max_row_idx = sequence_idx(on_grid_max_y, ymin);
      // std::cout << "min_row_idx: " << min_row_idx << ", max_row_idx: " <<
  ...
  // std::cout << "min_row_idx: " << min_row_idx << ", max_row_idx: " <<
  // max_row_idx << std::endl; std::cout << "min_col_idx: " << min_col_idx << ",
  // max_col_idx: " << max_col_idx << std::endl;
